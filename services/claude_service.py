...

{
  ...
  "prompt_immagine_modella": "Prompt in inglese per DALL-E 3: descrivi l'indumento in dettaglio per generare una foto di una modella che lo indossa. Sii molto specifico su colori, stile, forma.",
  "prompt_sfondo_bianco": "Prompt in inglese per DALL-E 3: descrivi l'indumento in dettaglio per generare una foto prodotto su sfondo bianco. Stile e-commerce professionale."
}
...
def analyze_clothing(image_paths: list[str], api_key: str) -> dict:
    ...
    content = []
    for path in image_paths[:4]:  # max 4 immagini
